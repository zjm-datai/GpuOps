...
from gpuops.schemas.workers import GPUDevicesStatus, SystemInfo

from .base import GPUDetector, SystemInfoDetector
from .runtime.runtime import Runtime
from .fastfetch.fastfetch import Fastfetch
